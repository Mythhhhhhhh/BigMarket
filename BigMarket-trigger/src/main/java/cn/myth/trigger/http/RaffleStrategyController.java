    ...
    public Response<List<RaffleAwardListResponseDTO>> queryRaffleAwardList(@RequestBody RaffleAwardListRequestDTO request) {
        try {
            ...
            for (StrategyAwardEntity strategyAwardEntity : strategyAwardEntities) {
                Integer awardRuleLockCount = ruleLockCountMap.get(strategyAwardEntity.ruleModels());
                raffleAwardListResponseDTOS.add(RaffleAwardListResponseDTO.builder()
                        .awardId(strategyAwardEntity.awardId())
                        .awardTitle(strategyAwardEntity.awardTitle())
                        .awardSubtitle(strategyAwardEntity.awardSubtitle())
                        .sort(strategyAwardEntity.sort())
